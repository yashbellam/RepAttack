...
import com.repattack.ui.screens.LogSessionScreen
import com.repattack.ui.theme.RepAttackTheme

class LogSessionActivity : ComponentActivity() {

    companion object {
        private const val EXTRA_WORKOUT_ID = "workout_id"

        fun newIntent(context: Context, workoutId: Long): Intent {
            return Intent(context, LogSessionActivity::class.java).apply {
            ...
            RepAttackTheme {
                LogSessionScreen(
                    ...
                    onShowExerciseHistory = { exerciseId, exerciseName ->
                        startActivity(
                            ExerciseHistoryActivity.newIntent(
                                this,
                                exerciseId,
                                exerciseName
                            )
